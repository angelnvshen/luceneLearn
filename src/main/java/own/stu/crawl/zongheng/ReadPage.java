...
import own.stu.crawl.zongheng.model.NovelReadModel;
...
public class ReadPage extends CrawlBase {
	...
	public static void main(String[] args) {
		...
		ReadPage readPage = new ReadPage("http://book.zongheng.com/chapter/656058/36167027.html");
		...
		bean.setChapterId(1);
		bean.setChapterTime(1490059807000l);
