...
import own.stu.crawl.CrawlBase;
import own.stu.crawl.zongheng.db.ZonghengDB;
import own.stu.crawl.zongheng.model.NovelChapterModel;
import own.stu.util.JsonUtil;
import own.stu.util.ParseMD5;
import own.stu.util.RegexUtil;
...
public class ChapterPage extends CrawlBase {
	...
	public static void main(String[] args) {
		...
		ChapterPage chapterPage = new ChapterPage("http://book.zongheng.com/showchapter/656058.html");
		...
		db.saveNovelChpter(chapterPage.analyzer(), "0cbeef95f6859eab76cd97afb79db27a");
	}
